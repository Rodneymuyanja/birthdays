...
<!-- End Header -->
  ...
  <!-- ======= Hero Section ======= -->
  <section id="bby" class="d-flex align-items-center" style="background-image: {{asset('assets/img/hero-bg.jpg') }};">
    ...
    <nav id="navbar" class="navbar">
      ...
      <div class="card-body card-c" >
        ...
        <div class="card " style="border:0px; ">
          ...
          <div class="card-body card-c" style="background-color:#c97d4b; margin-top:30px; width:60px; height:200px; margin-bottom:100px;">
            ...
            <div class="card-body card-c" data-aos="zoom-in" data-aos-delay="200"  data-aos="fade-down" data-aos-delay="70" style=" background-color:#c97d4b; margin-left:628px; margin-top:-290px; width:160px; height:100px; margin-bottom:100px;">
            
            </div>

            <div class="card-body icon-box" data-aos="fade-up" data-aos-delay="80" style="background-color:#c97d4b; margin-left:520px; margin-top:-90px; width:140px; height:90px; margin-bottom:100px; transition: all 0.3s ease-in-out;">
            ...
            <h1><div class="count-box"> <span data-purecounter-start="0" data-purecounter-end="{{date('d')}}" data-purecounter-duration="800" data-purecounter-delay="100" class="purecounter"></span></div><h1>
            ...
            <div class="card-body"  style="background-color:#fff;  margin-left:160px; margin-top:-300px; width:400px; height:150px; margin-bottom:200px;">
              <h2><p style="font-family: "Poppins, sans-serif;" data-aos="fade-up" data-aos-delay="80">hey this is your birthday and we don't need to prove ourselves to no one because we're who we are, so pick a leaf take the hats off</p></h2>
